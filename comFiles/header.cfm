<head>
	...
	<cfset jqText= jqText & "<script src='https://code.jquery.com/ui/1.12.0/jquery-ui.js'></script>">

	<!--- CSS関連 --->
	<cfset cssText="<link href='css/bootstrap.min.css' rel='stylesheet'>">
	<cfset cssText= cssText & "<link href='css/test.css' rel='stylesheet'>">
	<cfset cssText= cssText & "<link rel='stylesheet' href='//code.jquery.com/ui/1.12.0/themes/base/jquery-ui.css'>">
